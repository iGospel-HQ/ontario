...
//     enabled: open,
  ...
  const validateAccount = async () => {
    ...
    if (bankCode && accountNumber.length === 10) {
      ...
      try {
        const accountName = await apiService.getBankDetailsByNumber(accountNumber, bankCode)
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit((v) => addBankMutation.mutate(v))} className="space-y-4">
            <FormField
            ...
            <DialogFooter>
              <Button type="submit" disabled={addBankMutation.isPending || isValidating}>
